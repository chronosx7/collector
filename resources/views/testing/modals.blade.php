...
<div ng-app='collector_app' ng-controller='AppController as vm'>
    ...
    <button type="button" class="btn btn-default" ng-click="open_alert()">
        Open Alert Modal
    </button>
    <button type="button" class="btn btn-default" ng-click="open_error()">
        Open Error Modal
    </button>
</div>
@endsection
...
@section('custom_js')
    ...
    <script src='/js/testing/modals/app.js'></script>
